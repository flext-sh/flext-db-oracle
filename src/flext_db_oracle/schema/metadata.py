...
class ColumnMetadata(DomainValueObject):
    ...
    is_primary_key: bool = Field(False, description="Is primary key column")
    is_foreign_key: bool = Field(False, description="Is foreign key column")
...
class ConstraintMetadata(DomainValueObject):
    ...
    deferrable: bool = Field(False, description="Is constraint deferrable")
    initially_deferred: bool = Field(False, description="Is initially deferred")
