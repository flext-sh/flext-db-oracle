...
class FlextDbOracleServices(s[FlextDbOracleConfig]):
    ...
    def disconnect(self) -> r[None]:
        ...
        try:
            ...
            return r.fail(f"Disconnect failed: {e}")
    ...
    ) -> r[list[dict[str, t.Json.JsonValue]]]:
    ...
    def fetch_one(
        ...
        sql: str,
        params: dict[str, t.Json.JsonValue] | None = None,
    ) -> r[dict[str, t.Json.JsonValue] | None]:
        ...
        try:
            ...
            return r.fail(f"Fetch one failed: {e}")
    ...
    def get_schemas(self) -> r[list[str]]:
        ...
        try:
            ...
            return r.fail(f"Failed to get schemas: {e}")
    ...
    def get_tables(self, schema: str | None = None) -> r[list[str]]:
        ...
        try:
            ...
            return r.fail(f"Failed to get tables: {e}")
 ...
 """
            ...
            return r.fail(f"Failed to get columns: {e}")
 ...
 """
    ...
    def get_table_metadata(
        ...
        try:
            ...
            metadata: dict[str, t.Json.JsonValue] = {
                "table_name": table_name,
                "schema": schema,
                "columns": cast("t.Json.JsonValue", columns_result.unwrap()),
                "primary_keys": cast("t.Json.JsonValue", pk_result.unwrap()),
            }
    ...
    def get_metrics(self) -> r[dict[str, t.Json.JsonValue]]:
    ...
    def list_plugins(self) -> r[dict[str, t.Json.JsonValue]]:
    ...
    def track_operation(
        ...
        *,
        ...
        try:
            ...
            self._operations.append(cast("dict[str, t.Json.JsonValue]", operation))
            return r.ok(None)
        except Exception as e:
            return r.fail(f"Failed to track operation: {e}")

    def get_operations(self) -> r[list[dict[str, t.Json.JsonValue]]]:
