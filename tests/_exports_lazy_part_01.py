...
TESTS_FLEXT_DB_ORACLE_LAZY_IMPORTS_PART_01 = build_lazy_import_map(
    {
        ".base": ("TestsFlextDbOracleServiceBase",),
        ".conftest": ("conftest",),
        ".constants": (
...
__all__: list[str] = ["TESTS_FLEXT_DB_ORACLE_LAZY_IMPORTS_PART_01"]
