...
from src.flext_db_oracle import FlextDbOracleApi, FlextDbOracleConfig, FlextDbOracleConnection
...
class TestFlextDbOracleApi:
    ...
    def test_api_initialization_with_config(self, valid_config):
    ...
    def test_api_initialization_without_config(self):
    ...
    def test_connect_success(self, mock_connection_class, valid_config):
    ...
    @patch('src.flext_db_oracle.api.FlextDbOracleConnection')
    def test_connect_failure(self, mock_connection_class, valid_config):
    ...
    @patch('src.flext_db_oracle.api.FlextDbOracleConnection')
    def test_disconnect_success(self, mock_connection_class, valid_config):
    ...
    def test_disconnect_when_not_connected(self, valid_config):
    ...
    @patch('src.flext_db_oracle.api.FlextDbOracleConnection')
    def test_query_success(self, mock_connection_class, valid_config, sample_query_result):
    ...
    def test_query_not_connected(self, valid_config):
    ...
    @patch('src.flext_db_oracle.api.FlextDbOracleConnection')
    def test_query_with_parameters(self, mock_connection_class, valid_config):
    ...
    @patch('src.flext_db_oracle.api.FlextDbOracleConnection')
    def test_query_one_success(self, mock_connection_class, valid_config):
    ...
    @patch('src.flext_db_oracle.api.FlextDbOracleConnection')
    def test_execute_batch_success(self, mock_connection_class, valid_config):
    ...
    @patch('src.flext_db_oracle.api.FlextDbOracleConnection')
    def test_execute_batch_failure(self, mock_connection_class, valid_config):
    ...
    @patch('src.flext_db_oracle.api.FlextDbOracleConnection')
    def test_transaction_context_manager(self, mock_connection_class, valid_config):
    ...
    @patch('src.flext_db_oracle.api.FlextDbOracleConnection')
    def test_session_context_manager(self, mock_connection_class, valid_config):
    ...
    @patch('src.flext_db_oracle.api.FlextDbOracleConnection')
    def test_get_tables_success(self, mock_connection_class, valid_config):
    ...
    @patch('src.flext_db_oracle.api.FlextDbOracleConnection')
    def test_get_tables_with_schema(self, mock_connection_class, valid_config):
    ...
    @patch('src.flext_db_oracle.api.FlextDbOracleConnection')
    def test_get_schemas_success(self, mock_connection_class, valid_config):
    ...
    @patch('src.flext_db_oracle.api.FlextDbOracleConnection')
    def test_get_columns_success(self, mock_connection_class, valid_config):
    ...
    @patch('src.flext_db_oracle.api.FlextDbOracleConnection')
    def test_test_connection_success(self, mock_connection_class, valid_config):
    ...
    def test_test_connection_not_connected(self, valid_config):
    ...
    def test_properties(self, valid_config):
        """Test API properties."""
        api = FlextDbOracleApi(valid_config, "test_context")
    ...
    @patch('src.flext_db_oracle.api.FlextDbOracleConnection')
    def test_context_manager_connect(self, mock_connection_class, valid_config):
    ...
    @patch('src.flext_db_oracle.api.FlextDbOracleConnection')
    def test_context_manager_already_connected(self, mock_connection_class, valid_config):
    ...
    @patch('src.flext_db_oracle.api.FlextDbOracleConnection')
    def test_chaining_methods(self, mock_connection_class, valid_config):
    ...
    def test_container_registration(self, valid_config):
