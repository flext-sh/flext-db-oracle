...
class TestFlextDbOracleCliApplicationCoverage:
    ...
    def test_initialize_application_success(self, mock_register: Any) -> None:
    ...
    @patch("flext_db_oracle.cli.register_all_oracle_plugins")
    def test_initialize_application_failure(self, mock_register: Any) -> None:
...
class TestConnectionGroupCommands:
    ...
    def test_connection_test_success(self, mock_init: Any, mock_create_api: Any) -> None:
        ...
        mock_connected_api.test_connection.return_value = FlextResult[bool].ok(value=True)
    ...
    def test_connection_test_failure(self, mock_init: Any, mock_create_api: Any) -> None:
        ...
        mock_api.__enter__ = Mock(return_value=mock_connected_api)
        mock_api.__exit__ = Mock(return_value=None)
        mock_connected_api.test_connection.return_value = FlextResult[bool].fail("Connection failed")
        mock_create_api.return_value = mock_api
        ...
        assert "Connection test failed" in result.output or "Connection failed" in result.output
...
class TestConnectEnvCommand:
    ...
    @patch("flext_db_oracle.cli.FlextDbOracleUtilities.create_api_from_config")
    @patch("flext_db_oracle.cli.FlextDbOracleCliApplication.initialize_application")
    def test_connect_env_missing_config(self, mock_init: Any, mock_create_api: Any, mock_create_config: Any) -> None:
    ...
    @patch("flext_db_oracle.cli.FlextDbOracleUtilities.create_api_from_config")
    @patch("flext_db_oracle.cli.FlextDbOracleCliApplication.initialize_application")
    def test_connect_env_connection_error(self, mock_init: Any, mock_create_api: Any, mock_create_config: Any) -> None:
        """Test connect-env with connection error."""
        mock_init.return_value = FlextResult[None].ok(None)

        mock_config = FlextDbOracleConfig(
            host="localhost", port=1521, service_name="XE",
            username="test", password=SecretStr("password")
        )
...
class TestQueryCommandCoverage:
    ...
    @patch("flext_db_oracle.cli.FlextDbOracleUtilities.create_api_from_config")
    @patch("flext_db_oracle.cli.FlextDbOracleCliApplication.initialize_application")
    def test_query_config_error(self, mock_init: Any, mock_create_api: Any, mock_create_config: Any) -> None:
        """Test query command with configuration error."""
        mock_init.return_value = FlextResult[None].ok(None)
        mock_create_config.return_value = FlextResult[FlextDbOracleConfig].fail("Invalid configuration")
    ...
    @patch("flext_db_oracle.cli.FlextDbOracleCliApplication.initialize_application")
    def test_query_with_limit_applied(self, mock_init: Any, mock_format: Any, mock_create_api: Any, mock_create_config: Any) -> None:
...
class TestSchemasTablesCommands:
    ...
    @patch("flext_db_oracle.cli.FlextDbOracleUtilities.create_api_from_config")
    @patch("flext_db_oracle.cli.FlextDbOracleCliApplication.initialize_application")
    def test_schemas_command_error(self, mock_init: Any, mock_create_api: Any, mock_create_config: Any) -> None:
        ...
        mock_api.__enter__ = Mock(return_value=mock_connected_api)
        mock_api.__exit__ = Mock(return_value=None)
        mock_connected_api.get_schemas.return_value = FlextResult[list].fail("Access denied")
        mock_create_api.return_value = mock_api
    ...
    @patch("flext_db_oracle.cli.FlextDbOracleUtilities.create_api_from_config")
    @patch("flext_db_oracle.cli.FlextDbOracleCliApplication.initialize_application")
    def test_tables_command_with_schema(self, mock_init: Any, mock_create_api: Any, mock_create_config: Any) -> None:
        ...
        mock_api.__enter__ = Mock(return_value=mock_connected_api)
        mock_api.__exit__ = Mock(return_value=None)
        mock_connected_api.get_tables.return_value = FlextResult[list].ok(["TABLE1", "TABLE2"])
        mock_create_api.return_value = mock_api
...
class TestHealthCommand:
    ...
    @patch("flext_db_oracle.cli.FlextDbOracleUtilities.create_api_from_config")
    @patch("flext_db_oracle.cli.FlextDbOracleCliApplication.initialize_application")
    def test_health_command_healthy(self, mock_init: Any, mock_create_api: Any, mock_create_config: Any) -> None:
    ...
    @patch("flext_db_oracle.cli.FlextDbOracleUtilities.create_api_from_config")
    @patch("flext_db_oracle.cli.FlextDbOracleCliApplication.initialize_application")
    def test_health_command_unhealthy(self, mock_init: Any, mock_create_api: Any, mock_create_config: Any) -> None:
        ...
        mock_api.__enter__ = Mock(return_value=mock_connected_api)
        mock_api.__exit__ = Mock(return_value=None)
        mock_connected_api.test_connection.return_value = FlextResult[bool].fail("Connection timeout")
        mock_create_api.return_value = mock_api
...
class TestPluginsCommand:
    ...
    @patch("flext_db_oracle.cli.FlextDbOracleUtilities.create_api_from_config")
    @patch("flext_db_oracle.cli.FlextDbOracleCliApplication.initialize_application")
    def test_plugins_list_command(self, mock_init: Any, mock_create_api: Any, mock_create_config: Any) -> None:
...
class TestConfigCommands:
    ...
    @patch("flext_db_oracle.cli.FlextDbOracleCliApplication.initialize_application")
    def test_config_validate_command_no_file(self, mock_init: Any) -> None:
...
class TestInteractiveCommands:
    ...
    @patch("flext_db_oracle.cli.FlextDbOracleCliApplication.initialize_application")
    def test_interactive_wizard(self, mock_init: Any, mock_prompt: Any) -> None:
