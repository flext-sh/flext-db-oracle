...
from src.flext_db_oracle import FlextDbOracleConnection, FlextDbOracleConfig
...
class TestFlextDbOracleConnection:
    ...
    def test_connection_initialization(self, valid_config):
    ...
    def test_connect_success(self, mock_create_engine, valid_config):
    ...
    @patch('src.flext_db_oracle.connection.create_engine')
    def test_connect_failure(self, mock_create_engine, valid_config):
    ...
    def test_connect_with_invalid_config(self, invalid_config):
    ...
    @patch('src.flext_db_oracle.connection.create_engine')
    def test_disconnect_success(self, mock_create_engine, valid_config):
    ...
    @patch('src.flext_db_oracle.connection.create_engine')
    def test_execute_select_success(self, mock_create_engine, valid_config):
    ...
    @patch('src.flext_db_oracle.connection.create_engine')
    def test_execute_dml_success(self, mock_create_engine, valid_config):
    ...
    def test_execute_not_connected(self, valid_config):
    ...
    @patch('src.flext_db_oracle.connection.create_engine')
    def test_execute_sql_error(self, mock_create_engine, valid_config):
    ...
    @patch('src.flext_db_oracle.connection.create_engine')
    def test_execute_many_success(self, mock_create_engine, valid_config):
    ...
    @patch('src.flext_db_oracle.connection.create_engine')
    def test_fetch_one_success(self, mock_create_engine, valid_config):
    ...
    @patch('src.flext_db_oracle.connection.create_engine')
    def test_session_context_manager(self, mock_create_engine, valid_config):
    ...
    @patch('src.flext_db_oracle.connection.create_engine')
    def test_session_rollback_on_error(self, mock_create_engine, valid_config):
    ...
    @patch('src.flext_db_oracle.connection.create_engine')
    def test_transaction_context_manager(self, mock_create_engine, valid_config):
    ...
    @patch('src.flext_db_oracle.connection.create_engine')
    def test_transaction_rollback_on_error(self, mock_create_engine, valid_config):
    ...
    @patch('src.flext_db_oracle.connection.create_engine')
    def test_test_connection_success(self, mock_create_engine, valid_config):
    ...
    @patch('src.flext_db_oracle.connection.create_engine')
    def test_get_table_names_success(self, mock_create_engine, valid_config):
    ...
    @patch('src.flext_db_oracle.connection.create_engine')
    def test_get_table_names_with_schema(self, mock_create_engine, valid_config):
    ...
    @patch('src.flext_db_oracle.connection.create_engine')
    def test_get_schemas_success(self, mock_create_engine, valid_config):
    ...
    @patch('src.flext_db_oracle.connection.create_engine')
    def test_get_column_info_success(self, mock_create_engine, valid_config):
    ...
    def test_build_connection_url_service_name(self, valid_config):
    ...
    def test_build_connection_url_sid(self):
    ...
    def test_build_connection_url_no_identifier(self):
