...
class TestFlextDbOracleClientRealFunctionality:
    ...
    def test_client_with_testbuilders_pattern_real(self) -> None:
        ...
        FlextTestsMatchers().assert_result_success(
            cast_to_json_value(cast("FlextResult[object]", result))
        )
...
class TestClientModule:
    ...
    class _TestDataHelper:
        ...
        @staticmethod
        def create_test_client_config() -> dict[str, object]:
        ...
        @staticmethod
        def create_test_connection_data() -> dict[str, object]:
        ...
        @staticmethod
        def create_test_pool_data() -> dict[str, object]:
