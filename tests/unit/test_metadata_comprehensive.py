...
class TestFlextDbOracleMetadataManagerComprehensive:
    ...
    def test_get_table_metadata_structure(self) -> None:
        ...
        # Test with schema
        result_with_schema = self.manager.get_table_metadata("TEST_TABLE", "TEST_SCHEMA")
        assert not result_with_schema.success
    ...
    def test_generate_ddl_structure(self) -> None:
        ...
        from flext_db_oracle.models import FlextDbOracleTable, FlextDbOracleColumn
    ...
    def test_manager_real_functionality_coverage(self) -> None:
        ...
        expected_methods = [
            'get_schemas', 'get_tables', 'get_columns', 'get_table_metadata',
            'get_column_metadata', 'get_schema_metadata', 'generate_ddl', 
            'test_connection'
        ]
