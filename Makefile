...
help: ## Show this help message
	@echo "FLEXT-DB-ORACLE Development Commands"
	@echo "===================================="
...
# Code quality
lint: ## Run linters
	@echo "🔍 Running linters for flext-db-oracle..."
	@python -m ruff check .
	@python -m mypy src/ || true

format: ## Format code
	@echo "🎨 Formatting code for flext-db-oracle..."
	@python -m black .
