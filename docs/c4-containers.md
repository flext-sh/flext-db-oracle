...
graph TB
    subgraph "FLEXT Ecosystem Applications"
        ...
        client-a_APP[client-a-oud-mig<br/>🐍 Python Application<br/>Migration Tool]
    end
    ...
    class TAP_APP,TARGET_APP,DBT_APP,client-a_APP application
