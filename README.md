...
FLEXT DB Oracle - Enterprise Oracle Database Operations Library

## Module Map

- Primary facades: `FlextDbOracleExceptions`, `FlextDbOracleServiceSinger`, `FlextDbOracleServices`, `FlextDbOracleApi`, `FlextDbOracleDispatcher`, `FlextDbOraclePassword` (+16 more)
...
2. Confirm parent MRO chain via `pyproject.toml` `dependencies` filtered by `flext-*` (excluding `flext-db-oracle` self).
...
- Public extensions exposed by this project: `FlextDbOracleExceptions`, `FlextDbOracleServiceSinger`, `FlextDbOracleServices`, `FlextDbOracleApi`, `FlextDbOracleDispatcher`, `FlextDbOraclePassword` (+16 more).
